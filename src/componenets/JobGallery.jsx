  ...
  return (
    <div className='flex flex-col md:flex-row items-center gap-8 justify-between my-20'>
      ...
      <div className='w-[50%] space-y-6'>
                  <h1 className='text-black font-bold text-xl md:text-2xl lg:text-4xl'><span className='text-[#727272]'>Personalized </span> Job  <span className='text-[#ff900e]'>Recommendations</span></h1>
